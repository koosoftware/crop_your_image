...
class _CropEditorState extends State<_CropEditor> {
  ...
  void _updateScale(ScaleUpdateDetails detail) {
    ...
    double finalNewImageRectWidth = _imageRect.width + widget.padding * 2;
    double finalNewImageRectHeight = _imageRect.height + widget.padding * 2;
  ...
  Future<void> _crop(bool withCircleShape) async {
    ...
    double paddingPx = widget.padding * screenSizeRatio / _scale;
