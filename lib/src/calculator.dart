...
class _HorizontalCalculator extends _Calculator {
  ...
  @override
  Rect imageRect(Size screenSize, double imageRatio, double padding) {
    final finalScreenSizeWidth = screenSize.width + padding * 2;
...
class _VerticalCalculator extends _Calculator {
  ...
  @override
  Rect imageRect(Size screenSize, double imageRatio, double padding) {
    final finalScreenSizeHeight = screenSize.height + padding * 2;

    final imageScreenWidth = finalScreenSizeHeight * imageRatio;
    final left = (screenSize.width - imageScreenWidth) / 2;
    final right = left + imageScreenWidth;
    return Rect.fromLTWH(
        left, (padding * -1), right - left, finalScreenSizeHeight);
  }
