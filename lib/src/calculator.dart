...
class _HorizontalCalculator extends _Calculator {
  ...
  Rect imageRect(
      Size screenSize, double imageWidth, double imageHeight, double padding) {
    final screenSizeWidth = screenSize.width - padding;
    final screenSizeHeight = screenSize.height - padding;
  ...
  @override
  double scaleToCover(Size screenSize, Rect imageRect, double padding) {
    return (screenSize.height - padding * 2) / imageRect.height;
  }

  @override
  double screenSizeRatio(
      image.Image targetImage, Size screenSize, double padding, double scale) {
    return targetImage.width / ((screenSize.width - padding * 2) * scale);
  }
}
...
class _VerticalCalculator extends _Calculator {
  ...
  @override
  double scaleToCover(Size screenSize, Rect imageRect, double padding) {
    return (screenSize.width - padding * 2) / imageRect.width;
  }

  @override
  double screenSizeRatio(
      image.Image targetImage, Size screenSize, double padding, double scale) {
    return targetImage.height / ((screenSize.height - padding * 2) * scale);
  }
}
